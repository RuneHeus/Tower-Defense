    ...
    (define (iter counter)
      (if (not (= counter n))
          (let ((monster1 (make-monster "Purple" (make-position (start-position 'get-x) (start-position 'get-y))))
                ...
                (monster3 (make-monster "Red" (make-position (start-position 'get-x) (start-position 'get-y))))
                (monster4 (make-monster "Red" (make-position (start-position 'get-x) (start-position 'get-y))))
                (monster5 (make-monster "Red" (make-position (start-position 'get-x) (start-position 'get-y))))
                (monster6 (make-monster "Red" (make-position (start-position 'get-x) (start-position 'get-y)))))
            (set! wave-list (append wave-list (list monster1 monster2 monster3 monster4 monster5 monster6)))
            (iter (+ counter 1)))))
    (iter 0))
